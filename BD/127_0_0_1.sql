...
--
-- Host: 127.0.0.1
-- Tempo de geração: 22-Mar-2023 às 02:34
...
CREATE TABLE `tb_local` (
  ...
  `estado` varchar(35) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_cliente` int(11) NOT NULL,
...
INSERT INTO `tb_local` (`id_local`, `nome_local`, `id_categoria`, `desc_local`, `telefone`, `cep`, `estado`, `id_cliente`, `img1`, `img2`, `img3`) VALUES
(1, 'Quadra Futsal', 1, 'Bater aquela bolinha de cria', '11940028922', '08485430', 'São Paulo', 2, '', '', ''),
(2, 'Mário kart quadras', 1, 'Melhor lugar pra tirar a ponta do dedo', '123123421', '12313333', 'SP', 4, '', '', ''),
(17, 'Quadrinha', 1, 'de areia', '1111222', '121212', 'RJ', 3, 'imgsquadras/0339be6c103e396db084949d7c8b85c2.jpg', 'imgsquadras/ff2853bc17a97f581fa75414285587f3.jpg', '');
...
('root', '[{\"db\":\"bd_buscampo\",\"table\":\"tb_locatario\"},{\"db\":\"bd_buscampo\",\"table\":\"tb_local\"},{\"db\":\"bd_buscampo\",\"table\":\"tb_locador\"}]');
...
('root', '2023-03-21 22:40:23', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pt\"}');
